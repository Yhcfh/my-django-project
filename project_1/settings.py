...
SECRET_KEY = 'django-insecure-$7x(_p)5u!q_%e^5-e1wkz%n!&6g30h-s6smrylr8=z1te%djo'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'mydatabase',  # Database name (If it doesn't exist, create it in MySQL Workbench)
